...
<th>Total Price</th>
<th>Order Status</th>
<th colspan=2 sytle="align=left">Action</th>
</tr></thead><tbody>
<?php
include ("db_connect.php");
$result=mysqli_query($conn,"SELECT * FROM order_database WHERE order_status!='Completed' AND order_status!='Canceled' ORDER BY order_id ASC");
...
foreach ($datas as $data){
    ...
    echo "<td>";
    echo "<a href='adminOrderManagementProceed.php?orderNo=$orderNo'>PROCEED</>";
    echo "</td>";

    echo "<TD><a href='adminOrderCancel.php?orderNo=$orderNo'>CANCEL</>";
    echo "</td>";
    echo "</tr>";
    $orderNo += 1;
}      
